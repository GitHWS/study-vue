...
export default {
  ...
  setup() {
    ...
    // NOTE Options API에서 $route 객체를 Composition API에서 접근하기 위해 useRoute 컴포저블 함수를 사용하여 접근할 수 있다.
    const route = useRoute();

    // $route 객체에 접근하여 라우트 경로에 첨부된 데이터(meta, query, path, params 등)에 접근할 수 있다.
