...
// SECTION Search data / Computed / Method / Watcher
...
const availableUsers = computed(() => {
  ...
  if (activeSearchTerm.value) {
    users = props.users.filter((usr) => {
      return usr.fullName.includes(activeSearchTerm.value);
    });
  } else if (props.users) {
    users = props.users;
  }
...
// !SECTION Search data / Computed / Methods

// SECTION Sorting data / Computed / Methods
