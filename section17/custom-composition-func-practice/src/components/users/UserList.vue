...
export default {
  ...
  emits: ['list-projects'],
  setup(props) {
    // SECTION Search 기능의 공통 로직을 Custom Composition Function으로 대체하면 간결한 코드로 동일한 기능을 할 수 있다.
    const { users } = toRefs(props);

    // NOTE 인자를 전달한 Custom Hook의 반환 값을 구조 분해를 통해 사용할 수 있다.
    ...
    // !SECTION Search 기능의 공통 로직을 Custom Composition Function으로 대체하기

    // SECTION Sort 기능의 공통 로직을 Custom Composition Function으로 대체하기
